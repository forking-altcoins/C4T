                                                                    ...
                                                                    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Coin4Trade") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
/* On x86 add a bit specifier to the version so that users can distinguish between
    ...
    if (about) {
        setWindowTitle(tr("About Coin4Trade"));
        ...
        QString header = tr("Usage:") + "\n" +
                         "  coin4trade-qt [" + tr("command-line options") + "]                     " + "\n";
