Contributing to Coin4Trade Core
============================

The Coin4Trade Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Coin4Trade Core project, and is not to be
confused with overall Coin4Trade Network Protocol consensus changes.

Whether a pull request is merged into Coin4Trade Core rests with the project merge
...
Patches that change Coin4Trade consensus rules are considerably more involved than
...
Where a patchset proposes to change the Coin4Trade consensus, it must have been
...
The project leader is the release manager for each Coin4Trade Core release.
