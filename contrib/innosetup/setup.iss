...
#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/C4T/bootstrap.zip"
...
DefaultDirName={autopf}\Coin4Trade
...
OutputDir=.\output
OutputBaseFilename=Coin4TradeSetup
...
DefaultGroupName=Coin4Trade Core
...
[Files]
Source: ".\package\coin4trade-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Coin4Trade\Coin4Trade-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Coin4Trade\Coin4Trade-Qt,strDataDir|{userappdata}\Coin4Trade\}');
  Result := True;
end;
