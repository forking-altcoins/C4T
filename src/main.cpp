...
/** Fees smaller than this (in uC4T) are considered zero fee (for relaying, mining and transaction creation)
...
*/
        ...
        CPubKey pubKeyNew;
        privKeyNew.MakeNewKey(false);
        strstr sporkSecret = DecodeSecret(privKeyNew).ToString();
