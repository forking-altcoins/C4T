...
"""Verify that starting coin4trade with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start coin4trade with -? for help text")
        ...
        self.log.info("Start coin4trade with -version for version information")
